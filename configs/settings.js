...
module.exports = {
    ...
    session_secret: 'director', // 务必修改
    auth_cookie_name: 'director',
    ...
    // 密码盐
    encrypt_key: 'dire',
    salt_aes_key: "director_", // 可以解密，秘钥必须为：8/16/32位
    salt_md5_key: "dire", // MD5的盐，用于加密密码

    //    数据库配置
    URL: 'mongodb://127.0.0.1:27017/director2',
    DB: 'director2',
    HOST: '127.0.0.1',
    PORT: 27017,
    USERNAME: 'director',
    ...
    // 站点基础信息配置
    DORACMSAPI: 'http://api.felzx.cn', // 系统服务提供商
